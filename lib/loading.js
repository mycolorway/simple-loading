...
Loading = (function(_super) {
  ...
  Loading.prototype._render = function() {
    ...
    if (this.isGlobal) {
      ...
      if (this.opts.image) {
        this.loadingEl.text(this.opts.msg).css({
          backgroundImage: "url(" + this.opts.image + ")"
        });
      } else {
        this.loadingEl.html("" + Loading._tpl.icon + " " + this.opts.msg);
      }
  ...
  Loading.prototype.hide = function() {
    if (this.isGlobal) {
      ...
      return this.btnEl.show().next(".simple-tiny-loading").hide();
    }
  };
  ...
  Loading.prototype.destroy = function() {
    if (this.isGlobal) {
      ...
      return this.btnEl.show().next(".simple-tiny-loading").remove();
    }
  };
